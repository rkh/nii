...
module Nii::Units
  ...
  class Duration < GenericUnit
    ...
    self.units      =  {
      'day'         => { factor: 86400, systems: ["metric", "ussystem", "uksystem"], symbol: 'days' },
      'day-person'  => { factor: 86400, systems: ["metric", "ussystem", "uksystem"] },
      'hour'        => { factor: 3600, systems: ["metric", "ussystem", "uksystem"], symbol: 'hr' },
      'microsecond' => { systems: ["si", "metric", "ussystem", "uksystem"], factor: 1r/1000000r },
      'millisecond' => { systems: ["si", "metric", "ussystem", "uksystem"], factor: 1r/1000r },
      'minute'      => { factor: 60, systems: ["metric", "ussystem", "uksystem"] },
      'nanosecond'  => { systems: ["si", "metric", "ussystem", "uksystem"], factor: 1r/1000000000r },
      'week'        => { factor: 604800, symbol: 'wks' },
      'week-person' => { factor: 604800 },
      base_unit     => { systems: ["si", "metric", "ussystem", "uksystem"], factor: 1, symbol: 'sec' }}
    self.aliases    =  {
      'days'        => 'day',
      'hr'          => 'hour',
      'sec'         => 'second',
