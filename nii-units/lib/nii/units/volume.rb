...
module Nii::Units
  ...
  class Volume < GenericUnit
    ...
    self.units     =  {
      ...
      'centiliter'             => { factor: 0.001r/100r, systems: ["metric"] },
      'cubic-centimeter'       => { systems: ["metric", "si"], factor: 1r/100r*1r/100r*1r/100r },
      ...
      'cubic-kilometer'        => { systems: ["metric", "si"], factor: 1000r*1000r*1000r },
      ...
      'cup-metric'             => { factor: 0.00025r, systems: ["metric"] },
      'deciliter'              => { factor: 0.001r/10r, systems: ["metric"] },
      ...
      'hectoliter'             => { factor: 0.001r*100r, systems: ["metric"] },
      'jigger'                 => { factor: CONSTANTS[:gal_to_m3]*3r/128r*2r, systems: ["ussystem"] },
      'liter'                  => { factor: 0.001r, systems: ["metric"], symbol: 'L' },
      'megaliter'              => { factor: 0.001r*1000000r, systems: ["metric"] },
      'milliliter'             => { factor: 0.001r/1000r, systems: ["metric"] },
      'pinch'                  => { factor: CONSTANTS[:gal_to_m3]/128r*128r, systems: ["ussystem"] },
      'pint'                   => { factor: CONSTANTS[:gal_to_m3]/8r, systems: ["ussystem"] },
      'pint-metric'            => { factor: 0.0005r, systems: ["metric"] },
