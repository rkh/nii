...
module Nii::Units
  ...
  class Length < GenericUnit
    ...
    self.units            =  {
      '100-kilometer'     => { factor: 100000 },
      'astronomical-unit' => { factor: 149597900000 },
      'centimeter'        => { factor: 1r/100r },
      'decimeter'         => { factor: 1r/10r },
      ...
      'micrometer'        => { factor: 1r/1000000r },
      'mile'              => { factor: CONSTANTS[:ft_to_m]*5280r, systems: ["ussystem", "uksystem"] },
      'mile-scandinavian' => { factor: 10000 },
      'millimeter'        => { factor: 1r/1000r },
      'nanometer'         => { factor: 1r/1000000000r },
      'nautical-mile'     => { factor: 1852, systems: ["ussystem", "uksystem"] },
      'parsec'            => { factor: 30856780000000000 },
      'picometer'         => { factor: 1r/1000000000000r },
